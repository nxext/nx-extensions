...
This project is built with Nx and follows the OSS project structure. The [Getting Started](https://nx.dev/nx-api/nx/documents/create-nx-workspace) guide shows how to work with Nx workspaces.
