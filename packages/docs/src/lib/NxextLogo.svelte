<svg width="100%" height="100%" viewBox="0 0 779 205" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" class="w-auto h-8 fill-current text-gray-700 dark:text-gray-50" stroke="currentColor">
