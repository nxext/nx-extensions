...
/**
 * Vendored from Nx (`packages/nx/src/plugins/js/project-graph/build-dependencies/strip-source-code.ts`),
 * removed in Nx 23 after being deprecated (and never intended to be public)
 * since Nx 20. Used by `TypeScriptSvelteImportLocator` to strip everything
 * but import/export/require statements before parsing `.svelte` files.
 */
